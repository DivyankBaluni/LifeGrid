...
exports.LifegridMLTriageClassifier = exports.CLINICAL_KNOWLEDGE_BASE = void 0;
// Symptom lexicon with condition definitions, keywords, Hindi/Hinglish terms, and clinical weights
exports.CLINICAL_KNOWLEDGE_BASE = [
    {
...
class LifegridMLTriageClassifier {
    /**
    ...
    static predict(params) {
        ...
        for (const entry of exports.CLINICAL_KNOWLEDGE_BASE) {
            let matchedCount = 0;
            const matchedTokens = [];
        ...
        else if (normP2 >= 0.35 || normP1 >= 0.25)
        ...
        const acuityScore = Math.min(100, Math.round(normP1 * 100 + normP2 * 65 + normP3 * 35 + normP4 * 10));
        ...
        const plainExplanation = `AI Triage model assessed acuity at ${acuityScore}/100 with ${Math.round(confidenceScore * 100)}% confidence. Identified ${primaryCondition} as principal clinical driver, indicating ${predictedPriority} dispatch urgency. Recommended specialist: ${primarySpecialist}.`;
        return {
...
exports.LifegridMLTriageClassifier = LifegridMLTriageClassifier;
