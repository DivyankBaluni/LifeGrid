...
export interface RouteOptimizationResult {
  ...
  signal_priority_applied: boolean;
  time_saved_minutes: number;
  final_eta_minutes: number;
  drone_fallback_triggered: boolean;
  drone_reason?: string;
}

// Static congestion model by time-of-day (ARCHITECTURE.md §6)
export function getStaticCongestionFactor(): { multiplier: number; period: string } {
